package rainbowfriends.daramserverdev.domain.time.service.impl

import org.springframework.stereotype.Service
import rainbowfriends.daramserverdev.domain.time.config.DeadlineConfig
import rainbowfriends.daramserverdev.domain.time.dto.enums.GetRemainTimeServiceAction
import rainbowfriends.daramserverdev.domain.time.dto.response.DetailedTimeResponse
import rainbowfriends.daramserverdev.domain.time.dto.response.SecondsResponse
import rainbowfriends.daramserverdev.domain.time.dto.response.TimeFormattedResponse
